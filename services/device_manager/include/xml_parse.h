...
public:
     ...
     * @param subSection Xml subSection.
     * @param property Xml property.
     * @param value Value type is char*.
     * @param valueLen Value length.
     * @return Success get specified property's value return true, else return false.
     * @since 6
     */
    bool GetValue(const std::string &section, const std::string &subSection, const std::string &property, char *value,
                  uint8_t valueLen);
