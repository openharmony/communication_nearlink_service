...
public:
     ...
     * @since 6
     */
    ProfileInfo(const std::string &name, uint32_t id, const std::string &uuid) : mName(name), mId(id), mUuid(uuid){};
    /**
...
public:
     ...
     * @since 6
     */
    static const std::vector<ProfileInfo> GetConfigSupportProfiles(SleTransport transport);
