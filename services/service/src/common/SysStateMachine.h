...
public:
     ...
     * @since 6
     */
    void Init(SleServiceManager &am);
};
...
public:
     ...
     * @since 6
     */
    SysState(const std::string &name, SysStateMachine &sysStateMachine, SleServiceManager &am)
...
public:
     ...
     * @since 6
     */
    SysStoppingBaseState(const std::string &name, SysStateMachine &sysStateMachine, SleServiceManager &am)
...
protected:
    void StoppingBaseProcess(int stateSle, SleEventType reason);
};
...
public:
     ...
     * @since 6
     */
    SysStoppedState(SysStateMachine &sysStateMachine, SleServiceManager &am)
...
public:
     ...
     * @since 6
     */
    SysStartedState(SysStateMachine &sysStateMachine, SleServiceManager &am)
...
public:
     ...
     * @since 6
     */
    SysStoppingState(SysStateMachine &sysStateMachine, SleServiceManager &am)
...
public:
     ...
     * @since 6
     */
    SysResettingState(SysStateMachine &sysStateMachine, SleServiceManager &am)
...
public:
     ...
     * @since 6
     */
    SysFactoryResettingState(SysStateMachine &sysStateMachine, SleServiceManager &am)
