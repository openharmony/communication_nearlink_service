...
#ifndef COMMON_REG_EXT_FUNC_H
#define COMMON_REG_EXT_FUNC_H
...
typedef bool (*COMMON_IsSupportConnHighSpeedPtr)(void);
typedef bool (*COMMON_IsSupportQueryQosInfoPtr)(void);
...
typedef struct {
    ...
    COMMON_IsSupportQueryQosInfoPtr isSupportQueryQosInfo;
