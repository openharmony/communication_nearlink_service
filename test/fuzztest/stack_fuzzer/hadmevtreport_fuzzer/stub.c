...
DLI_ExecuteCmdCbk g_hadmCbkList[DLI_CBK_MAX] = {0};
    ...
    const DLI_CbkLineStru *table, const uint32_t size)
{
    ...
    if (module == HADM) {
        g_hadmCbkList[HADM_ZERO] = table[HADM_ZERO].func;
        g_hadmCbkList[HADM_ONE] = table[HADM_ONE].func;
        g_hadmCbkList[HADM_TWO] = table[HADM_TWO].func;
        g_hadmCbkList[HADM_THREE] = table[HADM_THREE].func;
        g_hadmCbkList[HADM_FOUR] = table[HADM_FOUR].func;
    }
