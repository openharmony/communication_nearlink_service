...
#include "ohos.nearlink.advertising.ani.hpp"
...
ANI_EXPORT ani_status ANI_Constructor(ani_vm *vm, uint32_t *result)
{
    ...
    if (ANI_OK != ohos::nearlink::advertising::ANIRegister(env)) {
        std::cerr << "Error from ohos::nearlink::advertising::ANIRegister" << std::endl;
        status = ANI_ERROR;
    }
