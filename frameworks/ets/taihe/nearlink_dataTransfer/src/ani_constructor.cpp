...
#include "ohos.nearlink.dataTransfer.ani.hpp"
...
ANI_EXPORT ani_status ANI_Constructor(ani_vm *vm, uint32_t *result)
{
    ...
    if (ANI_OK != ohos::nearlink::dataTransfer::ANIRegister(env)) {
        std::cerr << "Error from ohos::nearlink::dataTransfer::ANIRegister" << std::endl;
        status = ANI_ERROR;
    }
