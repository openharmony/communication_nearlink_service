...
#ifndef ANI_NEARLINK_REMOTE_DEVICE_CALLBACK_H
#define ANI_NEARLINK_REMOTE_DEVICE_CALLBACK_H
...
extern std::vector<::taihe::optional<::taihe::callback<void(::ohos::nearlink::remoteDevice::AcbStateParam const&)>>>
...
#endif  // ANI_NEARLINK_REMOTE_DEVICE_CALLBACK_H