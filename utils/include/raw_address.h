...
public:
    // address length
    static constexpr int SLE_ADDRESS_STR_LEN = 17;
    static constexpr int SLE_ADDRESS_BYTE_LEN = 6;
    static constexpr int SLE_COLON_BYTE_SIZE = 1;

    static constexpr int SLE_LAP_HIGH_BYTE = 5;
    static constexpr int SLE_LAP_MIDDLE_BYTE = 4;
    static constexpr int SLE_LAP_LOW_BYTE = 3;
    static constexpr int SLE_UAP_BYTE = 2;
    static constexpr int SLE_NAP_HIGH_BYTE = 1;
    static constexpr int SLE_NAP_LOW_BYTE = 0;
     ...
     * @since 6
     */
    RawAddress& operator=(const RawAddress&) = default;
     ...
     * @since 6
     */
    void ConvertToUint8(uint8_t *dst, const size_t size = SLE_ADDRESS_BYTE_LEN) const;
     ...
     * @since 6
     */
    static RawAddress ConvertToString(const uint8_t *src, const size_t size = SLE_ADDRESS_BYTE_LEN);
     ...
     *
     * @param rhs Compared RawAddress instance.
     * @return Returns <b>true</b> if this RawAddress is not same as compared RawAddress;
     *         returns <b>false</b> if this RawAddress is same as compared RawAddress.
     * @since 6
     */
    bool operator!=(const RawAddress &rhs) const;
protected:
